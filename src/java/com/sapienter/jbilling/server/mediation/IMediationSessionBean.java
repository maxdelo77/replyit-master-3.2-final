...
public interface IMediationSessionBean {
    ...
    public Integer triggerMediationByConfigurationWithRecordsInjection(Integer configId, Integer entityId, List<String> encodedEventRecords);
    ...
    public List<MediationRecordDTO> getMediationRecordsByMediationProcessAndStatus(
            Integer mediationProcess, Integer mediationRecordStatusId);
    ...
    public void performMediation(IMediationProcess processTask, Integer configurationId, Integer processId, Integer executorId, Integer entityId, File eventFile, List<List<Record>> eventRecords);
}
