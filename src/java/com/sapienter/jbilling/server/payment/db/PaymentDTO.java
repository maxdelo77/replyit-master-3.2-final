...
public class PaymentDTO extends CustomizedEntity implements Serializable, Exportable {
    ...
    public Object[][] getFieldValues() {
        ...
        PaymentAuthorizationDTO latestAuthorization = (!paymentAuthorizations.isEmpty()
                ...
                : null);
        PaymentInfoChequeDTO paymentInfoChequeDTO = getPaymentInfoCheque();
        ...
        return new Object[][] {
            {
                ...
                (paymentInfoChequeDTO != null ? paymentInfoChequeDTO.getBank() : null),
                (paymentInfoChequeDTO != null ? paymentInfoChequeDTO.getNumber() : null),
                (paymentInfoChequeDTO != null ? paymentInfoChequeDTO.getDate() : null),
            }
        };
    }
}
