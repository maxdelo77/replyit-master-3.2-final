...
public class CreditCardBL extends ResultList
    ...
    private static final FormatLogger LOG = new FormatLogger(Logger.getLogger(CreditCardBL.class));
    ...
    static public boolean validate(CreditCardDTO dto) {
        ...
        if (dto.getCcExpiry() == null || dto.getName() == null ||
                dto.getNumber() == null) {
            retValue = false;
            new FormatLogger(Logger.getLogger(CreditCardBL.class)).debug("invalid " + dto);
        }
